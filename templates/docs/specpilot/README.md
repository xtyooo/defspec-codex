...
当前项目使用 `specpilot-codex` 安装的项目级 SpecPilot skills。你可以直接输入文本指令触发对应流程，例如：
...
Codex 会根据 `.codex/skills/specpilot-*`、`SPECPILOT.md`、`project.md`、`project-guide.md` 和需求记录将这些指令作为项目内工作流处理。`AGENTS.md` 不是必需文件；如果项目已有该文件，可作为补充上下文。
